...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${($$result.head += `<title>Sapper project template</title>`, "")}
	     ...
	     <h1 class="title">
	      ...
	      <div class="buttons">
	        <a href="about" class="button is-primary">Primary</a>
	        <a href="blog" class="button is-link">Link</a>
	      </div>`;
});
	...
	return `<nav class="navbar" role="navigation" aria-label="main navigation">
	  <div class="navbar-brand">
	    <a class="navbar-item" href="https://sapper.svelte.dev/">
	      <img src="https://sapper.svelte.dev/sapper-logo-horizontal.svg" width="112" height="28" alt="Sapper">
	    </a>
	    <a role="button" href="javascript:" class="navbar-burger burger" aria-label="menu" aria-expanded="false" data-target="navbarBasicExample">
	  ...
	  <div class="navbar-menu">
	    <div class="navbar-end">
	      <a href="." class="${[`navbar-item`, segment === undefined ? "is-active" : ""].join(' ').trim() }">
	        Home
	      </a>
		  <a href="blog" rel="prefetch" class="${[`navbar-item`, segment === "blog" ? "is-active" : ""].join(' ').trim() }">
	        Blog
	      </a>
	      <a href="about" class="${[`navbar-item`, segment === "about" ? "is-active" : ""].join(' ').trim() }">
	        About
	      </a>
	    </div>
	  </div>
